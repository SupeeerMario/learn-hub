...
const ContactUs = () => {
  return (
    <div>
       <Sidebar></Sidebar>
       {/*================= Team Parts ================== */}
    {/* <section class="bg-white dark:bg-gray-900 ml-64 p-12">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
        <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our Team</h2>
            <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Explore the LearnHub Team </p>
        </div> 
        <div class="grid gap-8 mb-2 lg:mb-16 md:grid-cols-2">
            <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                    <img class="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="" />
                </a>
                <div class="p-5">
                    <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                        <a href="#">Ahmed Magdy </a>
                    </h3>
                    <span class="text-gray-500 dark:text-gray-400"> FrontEnd Developer</span>
                    <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Ahmed drives the technical strategy of the LearnHub platform and brand.</p>
  ...
  <section class="bg-white dark:bg-gray-900 ml-64 mt-12 flex flex-col min-h-screen">
