...
const Package = () => {
    return (
        <div className="flex flex-col">
            ...
            <section class="dark:bg-gray-900 ml-64 mt-12 flex flex-col min-h-screen">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                        ...
                        <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Here at LearnHub, you can meet people and arrange your study plans easily and without efforts.</p>
                    </div>
